namespace TreeOfMana.Services.Document
{
    ...
    public class RemoveNodeAttributesProcessor : DocumentNodeProcessor, IDocumentProcessor
    {
        ...
        public override DocumentNodeActionTypes DocumentNodeActionType
        {
            get
            {
                return DocumentNodeActionTypes.RemoveNodeAttribute;
            }
        }
        ...
        /// </param>
        /// <param name="rule">
        /// The <see cref="Data.Models.DocumentNodeRule"/> used to apply the action for the <see cref="DocumentNodeActionType"/>.
        /// </param>
        /// <returns>
