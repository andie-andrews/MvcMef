namespace TreeOfMana.Services.Document
{
    ...
    public abstract class DocumentNodeProcessor
    {
        ...
        /// </summary>
        public abstract DocumentNodeActionTypes DocumentNodeActionType { get; }

        /// <summary>
        /// Method used to indicate whether the processor can process the specified <see cref="DocumentNodeActionType"/>
        /// </summary>
        ...
        /// </returns>
        public bool CanProcessDocument(DocumentNodeActionTypes documentNodeActionType)
        {
            return this.DocumentNodeActionType == documentNodeActionType;
        }
        ...
        {
            if (!this.CanProcessDocument((DocumentNodeActionTypes)rule.DocumentNodeActionTypeId))
            {
